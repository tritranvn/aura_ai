  ...
  return (
    <div className="w-full flex flex-col gap-6 animate-fade-in">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <h3 className="text-lg font-semibold text-center mb-2 text-medium-text">Original</h3>
          <img src={originalImageUrl} alt="Original" className="w-full h-auto rounded-lg shadow-md border border-dark-border" />
        </div>
        <div className="relative">
          <h3 className="text-lg font-semibold text-center mb-2 text-light-text">Edited</h3>
      ...
      {editedResult.text && (
         <div className="bg-dark-bg/50 border border-dark-border p-3 rounded-lg mt-2">
           <p className="text-sm text-medium-text italic">
             <span className="font-semibold text-light-text">Model's Note:</span> "{editedResult.text}"
           </p>
         </div>
      )}
    </div>
